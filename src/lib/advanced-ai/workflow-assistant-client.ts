/**
 * AI Workflow Assistant - Client-Safe Components
 *
 * Client-safe workflow recommendation and template suggestion functions.
 * This file contains only code that can run in the browser without server-only dependencies.
 */
