...
export const CITY_COORDINATES: Record<string, GeoCoord> = {
  ...
  'San Francisco': { lat: 37.7749, lng: -122.4194, x: 25, y: 28 },
  'London': { lat: 51.5074, lng: -0.1278, x: 45, y: 23 },
  'Paris': { lat: 48.8566, lng: 2.3522, x: 46, y: 24 },
  'Berlin': { lat: 52.5200, lng: 13.4050, x: 48, y: 23 },
  'Lagos': { lat: 6.5244, lng: 3.3792, x: 45, y: 41 },
  'Cairo': { lat: 30.0444, lng: 31.2357, x: 53, y: 32 },
  'Nairobi': { lat: -1.2921, lng: 36.8219, x: 57, y: 40 },
  'Tokyo': { lat: 35.6762, lng: 139.6503, x: 83, y: 28 },
  'Beijing': { lat: 39.9042, lng: 116.4074, x: 77, y: 28 },
  'Delhi': { lat: 28.7041, lng: 77.1025, x: 68, y: 32 },
  'Sydney': { lat: -33.8688, lng: 151.2093, x: 85, y: 52 },
  'Melbourne': { lat: -37.8136, lng: 144.9631, x: 83, y: 54 },
