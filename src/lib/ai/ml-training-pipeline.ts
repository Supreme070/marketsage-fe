/**
 * UmlUtrainingUpipeline - Frontend Stub
 * ==
 *
...
/**
 * UmlUtrainingUpipeline
 *
 * STUB - Does not contain real implementation.
 * All operations should make API calls to backend.
 */
class UmlUtrainingUpipeline {
  constructor() {
    console.warn('⚠️  Using stub UmlUtrainingUpipeline. Migrate to backend API.');
  }
...
export const mlUtrainingUpipeline = new UmlUtrainingUpipeline();
export default mlUtrainingUpipeline;
