...
// PATCH/Update WhatsApp campaign by ID
...
// DELETE WhatsApp campaign by ID
export async function DELETE(
  ...
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.whatsAppActivity.deleteMany({
        where: { campaignId },
      });
      
      // Delete the campaign
      await tx.whatsAppCampaign.delete({
        where: { id: campaignId },
      });
    });
